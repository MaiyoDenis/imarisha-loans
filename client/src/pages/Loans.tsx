...
import { Search, Plus, Filter, MoreHorizontal, FileText, CheckCircle, XCircle, Clock, CreditCard } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-8 space-y-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <Button className="shadow-lg shadow-primary/20" data-testid="button-new-loan">
