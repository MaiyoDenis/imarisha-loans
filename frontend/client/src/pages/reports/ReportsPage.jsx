            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-6 mb-6">
                <div>
                  ...
                  <input type="number" value={branchId || ''} onChange={function (e) { return setBranchId(e.target.value ? parseInt(e.target.value) : undefined); }} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Select branch"/>
                </div>
                ...
                {selectedReport === 'operations' && (<div>
                    ...
                    <input type="number" value={daysBack} onChange={function (e) { return setDaysBack(parseInt(e.target.value) || 1); }} className="w-full px-4 py-2 border border-gray-300 rounded-lg" min="1" max="365"/>
                  </div>)}

                <button onClick={handleGenerateReport} disabled={currentQuery.isLoading} className="w-full bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center gap-2">
              ...
              {reportData && (<>
                ...
                return (<div key={key} className="bg-white rounded p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <button onClick={handleExportExcel} disabled={exportExcelMutation.isPending} className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 disabled:opacity-50 flex items-center justify-center gap-2">
                        <Download className="w-4 h-4"/>
                        Export Excel
                      </button>
                    </div>
                    ...
                    <div className="border-t pt-4">
                      ...
                      <input type="text" value={recipients} onChange={function (e) { return setRecipients(e.target.value); }} placeholder="email1@example.com, email2@example.com" className="w-full px-4 py-2 border border-gray-300 rounded-lg mb-2 focus:ring-2 focus:ring-blue-500"/>

                      <input type="text" value={subject} onChange={function (e) { return setSubject(e.target.value); }} placeholder="Email subject" className="w-full px-4 py-2 border border-gray-300 rounded-lg mb-4 focus:ring-2 focus:ring-blue-500"/>

                      <button onClick={handleSendEmail} disabled={emailMutation.isPending || !recipients} className="w-full bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 disabled:opacity-50 flex items-center justify-center gap-2">
