    ...
    return (<div className="bg-white rounded-lg shadow p-6">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex items-center gap-2">
          {trend ? (<div className="flex items-center gap-1 text-red-600">
              <ArrowUpIcon className="w-4 h-4"/>
              <span className="text-sm font-medium">Increasing</span>
            </div>) : (<div className="flex items-center gap-1 text-green-600">
      ...
      <div className={"mt-6 border rounded-lg p-4 ".concat(isDemo ? 'bg-yellow-50 border-yellow-200' : 'bg-blue-50 border-blue-200')}>
        <p className={"text-sm ".concat(isDemo ? 'text-yellow-900' : 'text-blue-900')}>
